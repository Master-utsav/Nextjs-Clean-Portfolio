  ...
  return (
       <div className="relative w-full flex justify-end items-end">
        <Input
          ...
          placeholder="Search"
          variant="bordered"
          classNames={{input : "bg-transparent dark:bg-transparent w-[85%] dark:text-white text-black" , inputWrapper : "border-none rounded-md" , clearButton : ""}}
        ...
        />
         <AiOutlineSearch className="size-5 absolute top-[0.65rem] right-2 text-black dark:text-white"/>
       </div>
  );
};
