...
interface IconProps {
  ...
  iconPlacement: "left" | "right" | "hide-from-right" | "fixed-icon" | "end-icon";
    ...
    return (
      ...
      >
        {Icon && iconPlacement === "left" && (
          <div className="w-0 translate-x-[0%] pr-0 opacity-0 transition-all duration-200 group-hover:w-6 group-hover:translate-x-100 group-hover:pr-2 group-hover:opacity-100">
            <Icon />
          </div>
        )}
        ...
        {Icon && iconPlacement === "hide-from-right" && (
