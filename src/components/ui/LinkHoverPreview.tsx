    ...
    <>
      ...
      >
        <HoverCardPrimitive.Trigger
          ...
          className={cn("text-black dark:text-white z-50", className)}
          href={actualUrl ? actualUrl : url}
        >
          {children}
        </HoverCardPrimitive.Trigger>
              ...
              >
                ...
                >
                  ...
                  <Image
                    ...
                    layout={layout}
                    priority={true}
                    className="rounded-lg absolute inset-0 -z-10 blur-lg"
                    alt="preview image"
                  />
                </Link>
              </motion.div>
