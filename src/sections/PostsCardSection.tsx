      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 ">
        {name === "article" &&
          blogCardImageUrl.map((item, idx) => (
            <div key={idx} className="sm:w-76 w-full object-cover rounded-lg border-[1px] dark:border-blue-500/30 border-blue-800/30 electric-lightning-effect flex flex-col gap-2">
              <Image
                key={idx}
                src={item.src}
                isBlurred 
